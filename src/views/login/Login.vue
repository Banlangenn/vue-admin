        ...
        <div class="layout-container"> 
          <div class="lark-form"> 
            <div class="lark-form-main"> 
              <div class="lark-form-logo"> 
                <a href="/"> <img 
                  src="http://im.suning.com/images/logo.png" 
                  alt="豆芽" > </a> 
              </div> 
              <div class="lark-form-content form-pro"> 
                <div class="account-slogon"> 
                  <h2 class="account-slogon-main"> 欢迎回到豆芽</h2> 
                  <p class="account-slogon-subhead"> 
                    <span>写后台，就用豆芽</span>
                  </p> 
                </div> 

                <div class="account-login form-pro"> 
                  <el-form 
                    :model="loginForm" 
                    status-icon 
                    ref="loginForm" 
                    ...
                    <el-form-item>
                      <el-button 
                        ...
                        type="success" 
                        style="width:100%" 
                        @click.native="loginHandle" >登 录</el-button>         
                    </el-form-item>
                  </el-form>
                  <div class="third-login"> 
                    <div class="ant-row"> 
                      <div class="ant-col-12 dingtalk-link"> 
                        <a 
                          href="/login?login_type=dingtalk" 
                          title="钉钉登录"> <span class="dingtalk"/>微信登录</a> 
                      </div>
                      <div class="ant-col-12 dingtalk-extra"> 
...
import { login, getMenutData } from "@/services/api";
export default {
  data() {
    return {
      loginForm: {
...
.login {
  ...
  .main-wrapper {
    ...
    min-height: 100vh;
    /* background: #fafafa; */
    background: url("http://bpic.588ku.com/back_pic/04/84/37/5058d77791a86e5.jpg!r650/fw/800")
      no-repeat;
  ...
  .lark-form-main {
    background-color: rgba(53, 73, 95, 0.2);
